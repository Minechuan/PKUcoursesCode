...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        grad_layer_2 = (output_layer_1_act.T).dot(pred_y - gt_y)
        grad_layer_1 = input_vector.T.dot((pred_y - gt_y).dot(MLP_layer_2.T) * output_layer_1_act * (1 - output_layer_1_act))
