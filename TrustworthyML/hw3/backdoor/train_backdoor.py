...
parser.add_argument('--poison-type', type=str, default='clean-label', choices=['badnets', 'blend', 'clean-label', 'benign'], help='type of backdoor attacks used during training')
...
def main():
    ...
    if args.poison_type in ['badnets', 'blend']:
        # create train data only need partial image with trigger (not the target label & poison_num)
