...
class AntsGUI:
    ...
    def initialize_colony_graphics(self, gamestate):
        ...
        self.food_text = self.canvas.draw_text('食物    轮数', (20, 20))
        self.ant_text = self.canvas.draw_text('选择的蚂蚁: 无', (20, 140))
        self._click_rectangles = list()
        self._init_control_panel(gamestate)
        self._init_places(gamestate)

        start_text = self.canvas.draw_text('点击后开始游戏!', MESSAGE_POS)
